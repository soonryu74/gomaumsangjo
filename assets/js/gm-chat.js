...
(function () {
  ...
  var NODES = {
    cost: {
      ...
      links: [["장례비 가늠", "gaeum.html"], ["상품 안내", "sangpum.html"]],
    ...
    facility: {
      ...
      links: [["장례식장·납골당 찾기", "sikjang.html"], ["품목별 단가표", "danga.html"]],
      next: ["cost", "extra"]
    },
    extra: {
      q: "장례 중에 추가 비용이 생기나요",
      ...
      links: [["품목별 단가표", "danga.html"], ["대표의 글", "yaksok.html"]],
      next: ["dirty", "settle"]
    },
    dirty: {
      q: "직원이 노잣돈을 요구하면요",
    ...
    haeyak: {
      ...
      links: [["내 상조 점검", "jeoul.html"], ["결합상품 판별", "gyeolhap.html"]],
      next: ["prepay", "consult"]
    },
    product: {
      q: "상품이 어떻게 되나요",
    ...
    procedure: {
      ...
      links: [["무엇부터 해야 하나", "jeolcha.html"], ["기독교 장례", "christian.html"], ["모바일 부고장", "bugojang.html"]],
      next: ["speed", "product"]
    },
    consult: {
      q: "상담만 미리 받아도 되나요",
